...
[The manuscript](https://academic.oup.com/gbe/article/16/2/evae009/7596324) has been published in Genome Biology and Evolution, further details to come. For a detailed description of the statistical method, check out our [LD-ABF toy example](https://tris-10.github.io/LD-ABF/documentation/LD_ABF_toyExample.html) and [Connection to Other Statistics](https://tris-10.github.io/LD-ABF/documentation/ConnectionToOtherStatistics.html) 
